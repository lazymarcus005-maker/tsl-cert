...
SCHEDULE="valid:300 expired:120 notyet:120 wronghost:120 selfsigned:120 untrustedca:120 weakkey:120 wrongusage:120 wildcard:120 revoked:120 missingchain:120"
SCHEDULE_JSON='[
...
{"current_case":"${current_case}","next_case":"${next_case}","duration_seconds":${duration},"started_at_epoch":${now_epoch},"cycle_total_minutes":25,"schedule":${SCHEDULE_JSON}}
EOF
