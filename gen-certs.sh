...
mkdir -p "${CA_DIR}/newcerts" "${ROGUE_CA_DIR}/newcerts" "${OCSP_DIR}" "${SERVER_DIR}" "${STATE_DIR}"

touch "${CA_DIR}/index.txt" "${ROGUE_CA_DIR}/index.txt"
...
{"current_case":"valid","next_case":"expired","duration_seconds":300,"started_at_epoch":$(date -u +%s),"cycle_total_minutes":23,"schedule":[{"case":"valid","duration_seconds":300},{"case":"expired","duration_seconds":120},{"case":"notyet","duration_seconds":120},{"case":"wronghost","duration_seconds":120},{"case":"selfsigned","duration_seconds":120},{"case":"untrustedca","duration_seconds":120},{"case":"weakkey","duration_seconds":120},{"case":"wrongusage","duration_seconds":120},{"case":"wildcard","duration_seconds":120},{"case":"revoked","duration_seconds":120}]}
EOF
